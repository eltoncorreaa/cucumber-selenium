#language: pt
Funcionalidade: MB014 - Seguro Novo (PJ, V. Outros, Perfil, Órgão Público, Débito, Responsável pagamento)

  @MB014_ENDOSSO
  Esquema do Cenário: MB014 - Apólice auto mais anterior de outra seguradora com sinistro. Que seja pessoa fisica. Chassi de veiculo restrito.
    ...
    #---------------------------- Perfil ------------------------------------------------------------
    Quando Endosso - Perfil - preencher veiculo possui cabine suplementar "<cabine_complementar>"   
    ...
    #---------------------------- TELA DE VEICULO SEGUNDO ITEM----------------------------------------    
	Quando Endosso - Veiculo - preencher o campo Chassi "<chassi_segundo_item>"	
	Entao Endosso - Veiculo - preencher a primeira opcao modal
	Entao Endosso - Veiculo - clicar no botao salvar
	Quando Endosso - Veiculo - preencher o campo Uso "<uso_segundo_item>"
	Quando Endosso - Veiculo - preencher o campo Placa "<placa_2>"
	Quando Endosso - Veiculo - preencher o campo CEP "<cep>"	
	Então Endosso - Veiculo - clicar no botao Proximo Dados do Veiculo
    #------------------------------------------------------------------------------------------------
    
    #---------------------------- TELA DE PERFIL SEGUNDO ITEM ---------------------------------------
	...
	Quando Endosso - Perfil - preencher veiculo possui cabine suplementar "<cabine_complementar_segundo_item>"
	Quando Endosso - Perfil - clicar no botao proximo 
    #------------------------------------------------------------------------------------------------
