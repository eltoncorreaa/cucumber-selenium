#language: pt
Funcionalidade: MB_016 - Seguro Novo (PJ, V. Outros, Perfil, Órgão Público, Débito, Responsável pagamento)

  @MB016_ENDOSSO
  Esquema do Cenário: MB_016 - Apólice auto mais anterior de outra seguradora com sinistro. Que seja pessoa fisica. Chassi de veiculo restrito.
