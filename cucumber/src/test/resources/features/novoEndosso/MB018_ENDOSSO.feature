#language: pt
Funcionalidade: MB018 - ENDOSSO

  @MB018_ENDOSSO
  Esquema do Cenário: MB018 - Endosso - Inclusão de Veículo - Multiitem GOLD - Renovação Mapfre Sem Sinistro
