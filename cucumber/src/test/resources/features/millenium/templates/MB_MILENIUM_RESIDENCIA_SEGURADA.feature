...
Funcionalidade: Avaliacao do Seguro/Segurado -
  ...
  @MB_MILENIUM_RESIDENCIA_SEGURADA
  Esquema do Cenário: Seguro/Segurado - Teste tela Seguro/Segurado
    ...
    #------------------------------------ RESIDENCIA SEGURADA ---------------------------------------- 
    Quando Millenium - Residencia Segurada - preencher o campo tipo de risco "<tipo_risco>"
    Quando Millenium - Residencia Segurada - preencher o campo renovacao automatica "<renovacao_automatica>"
    Quando Millenium - Residencia Segurada - preencher o campo cep "<cep>"
    Quando Millenium - Residencia Segurada - preencher o campo numero "<numero>"
    ...
    Exemplos: 
    | cod_corretor | tipo_seguro | tipo_calculo | inicio_vigencia | operador | tipo_pessoa | cpf_cnpj    | nome_completo | data_nascimento | sexo      | estado_civil | atividade_segurado   |  renda_mensal    | orgao_publico | ddd_residencial | numero_residencial | ddd_celular | numero_celular | ddd_outros | numero_outros |           email | tipo_documento | numero_documento | orgao_expedidor | data_expedicao | atividade_economica | pais_residencia | segurado_responsavel_pagamento | tipo_risco							| renovacao_automatica | cep      | numero |
    | 71503        | Seguro Novo | Anual        | Data atual      |          | Física      | 11144477735 | TESTE TESTE   |        15121977 | Masculino | Solteiro     | ANALISTA DE SISTEMAS |  Até R$ 1.400,00 | Não           |             11  |       912345678    |     11      |      912245678 | 11         | 912345668     | teste@teste.com |             RG |          1234567 |  SSP - SP       | 15052000       | BANCO CENTRAL       | BRASIL          | Sim 							 | Casa Zona Rural Alvenaria (habitual) | Sim  				   | 51170590 |	284    |
